      ...
      <div className="bg-white p-8 rounded-3xl shadow-xl border border-slate-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="space-y-6">
            ...
            <section>
              <h4 className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-3">Current Diagnosis</h4>
              <div className="p-4 bg-blue-50 border border-blue-100 rounded-2xl">
                <p className="text-blue-900 font-bold">{patient.diagnosis}</p>
              </div>
            </section>
          </div>
          ...
          <div className="space-y-6">
            <section>
              <h4 className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-3">Active Symptoms</h4>
              <div className="flex flex-wrap gap-2">
                {patient.symptoms.map(s => (
                  <span key={s} className="bg-slate-100 text-slate-700 px-4 py-2 rounded-xl text-sm font-medium">{s}</span>
                ))}
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-2">
                {patient.medications.map(m => (
                  <div key={m} className="flex items-center gap-3 p-3 bg-emerald-50 border border-emerald-100 rounded-xl">
